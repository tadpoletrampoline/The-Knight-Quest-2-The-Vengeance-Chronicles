...
public class Main {
    ...
    static void menu(){
        ...
        System.out.println(BOLD + "Hello there! Welcome to " + WHITE_BG + BLACK + "THE KNIGHT'S QUEST 2: THE VENGEANCE CHRONICLES" + RESET + UNBOLD);
    ...
    static void instructions(){
        System.out.println("\n" + GREEN_BG + "Here are the controls!\n" + RESET);
        ...
        System.out.println(GREEN_BG + "That's all for the instructions. Good luck!" +RESET + "\n\n");
    ...
    static void gameIntro(){
        ...
        System.out.println("\n" +RED_BG+ BLACK+ person.getName() + " are you ready to defeat the wizard? Let's begin your journey..." + RESET);
